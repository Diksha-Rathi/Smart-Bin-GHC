...
urlpatterns = [
    ...
    url(r'^details_curr', 'bins.views.details_curr'), 
    url(r'^details_custom', 'bins.views.details_custom'), 
    url(r'^detail_graph', 'bins.views.detail_graph'), 
    url(r'^optimal-route', 'bins.views.optimalRoute'),
    url(r'^analytics', 'bins.views.analytics'), 
    url(r'^export', 'bins.views.export'), 
    url(r'^confirmation', 'bins.views.confirmation'), 
    url(r'^hello/$',hello),
    url(r'^$',myLogin),
    url(r'^login/$',myLogin),
